...
export const MONSTERS = [
  ...
  { id: 'wild_goblin',  name: 'Wild Goblin',   adultHP: 10, kidHP:  7, atk:  4, gold:  9, kidGold:  5 },
  { id: 'spore_beast',  name: 'Spore Beast',   adultHP:  8, kidHP:  5, atk:  2, gold:  7, kidGold:  3 },
  { id: 'bone_walker',  name: 'Bone Walker',   adultHP: 11, kidHP:  8, atk:  4, gold: 10, kidGold:  5 },
  ...
  { id: 'nymph',             name: 'Nymph',             adultHP:  9, kidHP:  6, atk:  2, gold:  8, kidGold:  4 },
  ...
  // st04 Tier 3
  { id: 'grave_robber',   name: 'Grave Robber',   adultHP: 10, kidHP:  7, atk:  3, gold:  9, kidGold:  5 },
  { id: 'evil_shaman',    name: 'Evil Shaman',    adultHP: 10, kidHP:  7, atk:  4, gold:  9, kidGold:  5 },
  { id: 'gravekeeper',    name: 'Gravekeeper',    adultHP: 10, kidHP:  7, atk:  3, gold:  9, kidGold:  5 },
  ...
  { id: 'cursed_archer',  name: 'Cursed Archer',  adultHP: 10, kidHP:  7, atk:  3, gold:  9, kidGold:  5 },

  // st04 Tier 4
  { id: 'arcane_cannon',         name: 'Arcane Cannon',         adultHP: 11, kidHP:  8, atk:  5, gold: 11, kidGold:  6 },
  { id: 'goat_man',              name: 'Goat Man',              adultHP: 11, kidHP:  8, atk:  5, gold: 12, kidGold:  6 },
  { id: 'hollow_soldier',        name: 'Hollow Soldier',        adultHP: 12, kidHP:  9, atk:  5, gold: 12, kidGold:  6 },
  { id: 'incubus',               name: 'Incubus',               adultHP: 11, kidHP:  8, atk:  5, gold: 12, kidGold:  6 },
  { id: 'scarecrow',             name: 'Scarecrow',             adultHP: 11, kidHP:  8, atk:  5, gold: 11, kidGold:  6 },
  { id: 'devil_well',            name: 'Devil Well',            adultHP: 12, kidHP:  9, atk:  5, gold: 12, kidGold:  6 },
  { id: 'death_machine',         name: 'Death Machine',         adultHP: 12, kidHP:  9, atk:  5, gold: 13, kidGold:  7 },
  { id: 'arcane_core',           name: 'Arcane Core',           adultHP: 11, kidHP:  8, atk:  5, gold: 11, kidGold:  6 },
  { id: 'machine_golem',         name: 'Machine Golem',         adultHP: 12, kidHP:  9, atk:  5, gold: 13, kidGold:  7 },
  { id: 'fallen_kingdom_knight', name: 'Fallen Kingdom Knight', adultHP: 12, kidHP:  9, atk:  6, gold: 13, kidGold:  7 },
  { id: 'calamity_priest',       name: 'Calamity Priest',       adultHP: 12, kidHP:  9, atk:  5, gold: 13, kidGold:  7 },
  { id: 'royal_tomb_guardian',   name: 'Royal Tomb Guardian',   adultHP: 12, kidHP:  9, atk:  6, gold: 14, kidGold:  7 },
  { id: 'judgement_soldier',     name: 'Judgement Soldier',     adultHP: 12, kidHP:  9, atk:  5, gold: 13, kidGold:  7 },
  { id: 'gem_thief',             name: 'Gem Thief',             adultHP: 11, kidHP:  8, atk:  5, gold: 12, kidGold:  6 },
  { id: 'cursed_king',           name: 'Cursed King',           adultHP: 12, kidHP:  9, atk:  6, gold: 14, kidGold:  7 },
  { id: 'evil_pudding',          name: 'Evil Pudding',          adultHP: 11, kidHP:  8, atk:  5, gold: 11, kidGold:  6 },
  { id: 'godblight_parasite',    name: 'Godblight Parasite',    adultHP: 12, kidHP:  9, atk:  5, gold: 13, kidGold:  7 },

  // st04 Tier 5 — bosses
  { id: 'dark_drake',              name: 'Dark Drake',               adultHP: 12, kidHP: 10, atk:  7, gold: 20, kidGold: 10 },
  { id: 'scylla',                  name: 'Scylla',                   adultHP: 12, kidHP: 10, atk:  7, gold: 20, kidGold: 10 },
  { id: 'stone_troll',             name: 'Stone Troll',              adultHP: 12, kidHP: 10, atk:  7, gold: 18, kidGold:  9 },
  { id: 'fat_beast',               name: 'Fat Beast',                adultHP: 12, kidHP: 10, atk:  7, gold: 18, kidGold:  9 },
  { id: 'war_ogre',                name: 'War Ogre',                 adultHP: 12, kidHP: 10, atk:  7, gold: 20, kidGold: 10 },
  { id: 'manticore',               name: 'Manticore',                adultHP: 12, kidHP: 10, atk:  8, gold: 22, kidGold: 11 },
  { id: 'stone_colossus',          name: 'Stone Colossus',           adultHP: 12, kidHP: 10, atk:  8, gold: 22, kidGold: 11 },
  { id: 'divine_beast_young',      name: 'Divine Beast',             adultHP: 12, kidHP: 10, atk:  7, gold: 20, kidGold: 10 },
  { id: 'divine_beast_adult',      name: 'Divine Beast (Elder)',     adultHP: 12, kidHP: 10, atk:  8, gold: 24, kidGold: 12 },
  { id: 'cursed_king_second_form', name: 'Cursed King (True Form)',  adultHP: 12, kidHP: 10, atk:  8, gold: 24, kidGold: 12 },
  { id: 'divine_beast_perfect',    name: 'Divine Beast (Perfect)',   adultHP: 12, kidHP: 10, atk:  8, gold: 24, kidGold: 12 },
];
